...
_FIXEDWALKFINISHED = _descriptor.Descriptor(
  ...
  full_name='protobuf.message.behaviour.FixedWalkFinished',
  filename=None,
  file=DESCRIPTOR,
...
_WALKCONFIGSAVED = _descriptor.Descriptor(
  ...
  full_name='protobuf.message.behaviour.WalkConfigSaved',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_CANCELFIXEDWALK = _descriptor.Descriptor(
  ...
  full_name='protobuf.message.behaviour.CancelFixedWalk',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_WALKOPTIMISERCOMMAND = _descriptor.Descriptor(
  ...
  full_name='protobuf.message.behaviour.WalkOptimiserCommand',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='walkConfig', full_name='protobuf.message.behaviour.WalkOptimiserCommand.walkConfig', index=0,
...
_FIXEDWALKCOMMAND_WALKSEGMENT = _descriptor.Descriptor(
  name='WalkSegment',
  full_name='protobuf.message.behaviour.FixedWalkCommand.WalkSegment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='direction', full_name='protobuf.message.behaviour.FixedWalkCommand.WalkSegment.direction', index=0,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='curvePeriod', full_name='protobuf.message.behaviour.FixedWalkCommand.WalkSegment.curvePeriod', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='normalisedVelocity', full_name='protobuf.message.behaviour.FixedWalkCommand.WalkSegment.normalisedVelocity', index=2,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='normalisedAngularVelocity', full_name='protobuf.message.behaviour.FixedWalkCommand.WalkSegment.normalisedAngularVelocity', index=3,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='duration', full_name='protobuf.message.behaviour.FixedWalkCommand.WalkSegment.duration', index=4,
...
_FIXEDWALKCOMMAND = _descriptor.Descriptor(
  ...
  full_name='protobuf.message.behaviour.FixedWalkCommand',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='segments', full_name='protobuf.message.behaviour.FixedWalkCommand.segments', index=0,
...
FixedWalkFinished = _reflection.GeneratedProtocolMessageType('FixedWalkFinished', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.FixedWalkFinished)
  ))
...
WalkConfigSaved = _reflection.GeneratedProtocolMessageType('WalkConfigSaved', (_message.Message,), dict(
  ...
  __module__ = 'message.behaviour.FixedWalkCommand_pb2'
  # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.WalkConfigSaved)
  ))
...
CancelFixedWalk = _reflection.GeneratedProtocolMessageType('CancelFixedWalk', (_message.Message,), dict(
  ...
  __module__ = 'message.behaviour.FixedWalkCommand_pb2'
  # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.CancelFixedWalk)
  ))
...
WalkOptimiserCommand = _reflection.GeneratedProtocolMessageType('WalkOptimiserCommand', (_message.Message,), dict(
  ...
  __module__ = 'message.behaviour.FixedWalkCommand_pb2'
  # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.WalkOptimiserCommand)
  ))
...
FixedWalkCommand = _reflection.GeneratedProtocolMessageType('FixedWalkCommand', (_message.Message,), dict(
  ...
  WalkSegment = _reflection.GeneratedProtocolMessageType('WalkSegment', (_message.Message,), dict(
    ...
    __module__ = 'message.behaviour.FixedWalkCommand_pb2'
    # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.FixedWalkCommand.WalkSegment)
    ))
  ,
  DESCRIPTOR = _FIXEDWALKCOMMAND,
  __module__ = 'message.behaviour.FixedWalkCommand_pb2'
  # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.FixedWalkCommand)
  ))
