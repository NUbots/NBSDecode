...
_LOOK_FIXATION = _descriptor.Descriptor(
  name='Fixation',
  full_name='protobuf.message.behaviour.Look.Fixation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='angle', full_name='protobuf.message.behaviour.Look.Fixation.angle', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='arcSize', full_name='protobuf.message.behaviour.Look.Fixation.arcSize', index=1,
...
_LOOK_SACCADE = _descriptor.Descriptor(
  name='Saccade',
  full_name='protobuf.message.behaviour.Look.Saccade',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dwellTime', full_name='protobuf.message.behaviour.Look.Saccade.dwellTime', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='angle', full_name='protobuf.message.behaviour.Look.Saccade.angle', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='arcSize', full_name='protobuf.message.behaviour.Look.Saccade.arcSize', index=2,
...
_LOOK_PAN = _descriptor.Descriptor(
  name='Pan',
  full_name='protobuf.message.behaviour.Look.Pan',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='angle', full_name='protobuf.message.behaviour.Look.Pan.angle', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='arcSize', full_name='protobuf.message.behaviour.Look.Pan.arcSize', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LOOK_PANSELECTION = _descriptor.Descriptor(
  name='PanSelection',
  full_name='protobuf.message.behaviour.Look.PanSelection',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='lookAtGoalInsteadOfBall', full_name='protobuf.message.behaviour.Look.PanSelection.lookAtGoalInsteadOfBall', index=0,
...
_LOOK = _descriptor.Descriptor(
  name='Look',
  full_name='protobuf.message.behaviour.Look',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
Look = _reflection.GeneratedProtocolMessageType('Look', (_message.Message,), dict(
  ...
  Fixation = _reflection.GeneratedProtocolMessageType('Fixation', (_message.Message,), dict(
    ...
    # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.Look.Fixation)
    ))
  ,
  ...
  Saccade = _reflection.GeneratedProtocolMessageType('Saccade', (_message.Message,), dict(
    ...
    __module__ = 'message.behaviour.Look_pb2'
    # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.Look.Saccade)
    ))
  ,
  ...
  Pan = _reflection.GeneratedProtocolMessageType('Pan', (_message.Message,), dict(
    ...
    __module__ = 'message.behaviour.Look_pb2'
    # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.Look.Pan)
    ))
  ,
  ...
  PanSelection = _reflection.GeneratedProtocolMessageType('PanSelection', (_message.Message,), dict(
    ...
    __module__ = 'message.behaviour.Look_pb2'
    # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.Look.PanSelection)
    ))
  ,
  DESCRIPTOR = _LOOK,
  __module__ = 'message.behaviour.Look_pb2'
  # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.Look)
  ))
