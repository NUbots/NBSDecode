...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n\x1bmessage/behaviour/Nod.proto\x12\x1aprotobuf.message.behaviour\"\x14\n\x03Nod\x12\r\n\x05value\x18\x01 \x01(\x08\x62\x06proto3')
)
...
_NOD = _descriptor.Descriptor(
  name='Nod',
  full_name='protobuf.message.behaviour.Nod',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='value', full_name='protobuf.message.behaviour.Nod.value', index=0,
...
Nod = _reflection.GeneratedProtocolMessageType('Nod', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:protobuf.message.behaviour.Nod)
  ))
